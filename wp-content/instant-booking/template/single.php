...
if($type_r == 'service'){
  ...
  $user_mail =get_userdata( $id_element)->user_mail ;
  $users_last_name = get_user_meta( $id_element , 'last_name', true);
  $users_first_name = get_user_meta( $id_element , 'first_name', true);
  $users_phone = get_user_meta( $id_element , 'user_phone', true);
